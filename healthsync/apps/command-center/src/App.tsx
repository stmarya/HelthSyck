...
function NavBar({
  ...
  const navLinkStyle = (
    ...
    fontWeight:
      (isAlert && criticalCount > 0) || isEmergency
        ? 700
        : isActive
          ? 600
          : undefined,
  ...
  return (
    <nav
      className={`${styles.navbar} cc-nav`}
      style={{
        background: "#1f2328",
        color: "#fff",
        padding: "0 16px",
    ...
    >
      ...
      <div
        className={`${styles.navbarTop} cc-nav-top`}
        style={{
          height: "44px",
          display: "flex",
          alignItems: "center",
      ...
      <div
        className={`${styles.navbarBottom} cc-nav-bottom`}
        style={{
          height: "36px",
          display: "flex",
          alignItems: "center",
          ...
          {NAV_BARIS_2.map((link) => {
            ...
            return (
              <NavLink
                ...
                style={({ isActive }) =>
                  navLinkStyle(isActive, link.isAlert, link.isEmergency)
                }
              >
                {alertLabel}
              </NavLink>
...
function AppShell() {
  ...
  return (
    <>
      ...
      <div
        className={`${styles.layout} ${styles.appShell} cc-shell`}
          ...
          <main className={styles.main} style={{ flex: 1, overflow: "auto" }}>
            <Routes>
              ...
              <Route
                path="/consultations"
                element={
                  <ErrorBoundary label="Konsultasi">
                    <ConsultationsPage />
                  </ErrorBoundary>
                }
              />
              <Route
                path="/hospitals"
                element={
                  <ErrorBoundary label="Rumah Sakit">
                    <HospitalsPage />
                  </ErrorBoundary>
                }
              />
              ...
              />
              <Route
                path="/command-center/hospitals"
                element={
                  <ErrorBoundary label="Ketersediaan RS">
                    <HospitalAvailabilityPage />
                  </ErrorBoundary>
                }
              />
            </Routes>
